    ...
    return (
      ...
      >
        ...
        <div className="text-white mb-4">
          <a className="underline" href="https://www.linkedin.com/in/raviarya009/" rel="noreferrer noopener" target="_blank">
            linkedin
          </a>
          <span className="font-bold mx-1">|</span>
          <a href="https://github.com/ravi-arya009/" rel="noreferrer noopener" target="_blank" className="underline">
            github
          </a>
        </div>
      </div>
